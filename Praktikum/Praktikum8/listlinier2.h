...
/* I.S. List mungkin kosong atau berisi elemen duplikat */
/* F.S. Semua elemen dengan nilai duplikat dihapus (hanya satu elemen per nilai yang tersisa) */
/* Elemen pertama dari setiap nilai tetap dipertahankan */
